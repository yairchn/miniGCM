...
def main():
    ...
    plt.suptitle("Momentum Flux $\overline{U'V'}$ / m$^{2}$ s$^{-2}$",size='14', fontname = 'Dejavu Sans')
    plt.savefig('UV_3l_'+folder+'.pdf', bbox_inches='tight',dpi=150)
