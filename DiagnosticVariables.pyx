...
cdef class DiagnosticVariables:
    ...
    cpdef stats_io(self, Parameters Pr, NetCDFIO_Stats Stats):
        ...
        Stats.write_global_mean('global_mean_gZ', self.gZ.values[:,:,0:Pr.n_layers])
        Stats.write_zonal_mean('zonal_mean_U',self.U.values)
        Stats.write_zonal_mean('zonal_mean_V',self.V.values)
        Stats.write_zonal_mean('zonal_mean_Wp',self.Wp.values[:,:,1:Pr.n_layers+1])
        Stats.write_zonal_mean('zonal_mean_gZ',self.gZ.values[:,:,0:Pr.n_layers])
        ...
        Stats.write_meridional_mean('meridional_mean_Wp',self.Wp.values[:,:,1:Pr.n_layers+1])
        Stats.write_meridional_mean('meridional_mean_gZ',self.gZ.values[:,:,0:Pr.n_layers])
