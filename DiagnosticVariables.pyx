...
cdef extern from "diagnostic_variables.h":
    void diagnostic_variables(double Rd, double Rv, double kappa, double p_ref,
...
cdef class DiagnosticVariables:
    ...
    cpdef update(self, Parameters Pr, Grid Gr, PrognosticVariables PV):
        ...
        for k in range(nl):
            ...
            with nogil:
                diagnostic_variables(Pr.Rd, Pr.Rv, Pr.kappa, Pr.p_ref, &PV.P.values[0,0,0], &PV.T.values[0,0,0],
